    ...
    <>
        ...
        <div className="hero__content">
          <div className="hero__text">
            ...
            <div className="hero__actions">
              <button className="hero__btn-primary" onClick={scrollToGallery}>
                View Gallery
              </button>
              <button className="hero__btn-secondary" onClick={() => navigate('/login')}>
                Get Started
              </button>
            </div>
          </div>
      ...
      <section className="cta-section">
        ...
        <div className="cta-section__content">
          ...
          <button className="cta-section__btn" onClick={() => navigate('/gallery')}>
