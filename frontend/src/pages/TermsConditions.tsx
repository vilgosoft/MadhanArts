    ...
    <div className="legal-page">
      <header className="legal-page__hero">
        <div className="legal-page__hero-inner">
          ...
          <p className="legal-page__lead">Please read these terms carefully before using our platform.</p>
        </div>
      </header>
        ...
        <div className="legal-page__container">
          ...
          <section className="legal-page__section">
            ...
            <p>
              ...
              domain name <a href="https://www.madhanarts.in" target="_blank" rel="noopener noreferrer">www.madhanarts.in</a> ("Website"),
          ...
          <section className="legal-page__section">
            ...
            <p>
              ...
              for such transaction. By mere use of the Platform, You shall be contracting with
              the Platform Owner and these terms and conditions including the policies constitute
              Your binding obligations, with Platform Owner.
            </p>
            <p>
              These Terms of Use relate to your use of our website, goods (as applicable) or
              services (as applicable) (collectively, "Services"). Any terms and conditions
              proposed by You which are in addition to or which conflict with these Terms of Use
              are expressly rejected by the Platform Owner and shall be of no force or effect.
              These Terms of Use can be modified at any time without assigning any reason. It is
            ...
            <p>
              ...
              "your" or "user" shall mean any natural or legal person who has agreed to become
              a user/buyer on the Platform.
            </p>
          ...
          <section className="legal-page__section">
            ...
            <ul className="legal-page__list">
              ...
              <li>
                ...
                and discretion for which we shall not be liable to you in any manner. You are required
          ...
          <section className="legal-page__section">
            ...
            <p>
              ...
              any claim or demand, or actions including reasonable attorneys' fees, made by any third
          ...
          <section className="legal-page__section">
            ...
            <p>
              ...
              incidental, special or punitive damages, including without limitation damages for loss
              of profits or revenues, business interruption, loss of business opportunities, loss of
              data or loss of other economic interests, whether in contract, negligence, tort or
              otherwise, arising from the use of or inability to use the Services, however caused
              and whether arising in contract, tort, negligence, warranty or otherwise, exceed the
              amount paid by You for using the Services giving rise to the cause of action or Rupees
          ...
          <section className="legal-page__contact">
            <h2>Contact Us</h2>
            <p>All concerns or communications relating to these Terms must be communicated to us:</p>
            <ul>
